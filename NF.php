...
<?php inicio_nav(); ?>
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item"><a href="NF.php?pagina=1" class="nav-link active">Relatório p/ NF</a></li>
...
<?php
  ...
  <div class=\"container-fluid\" style=\"\">
    ...
    <div class=\"row\">
        <div class=\"col-lg-12\">
          <form method=\"post\" action=\"nf_generate.php\">
            <h3 class=\"text-center\">Selecione os registros e clique em +</h3>";
            ...
            <table class=\"table table-hover order-table table\" id=\"manut_maquinas\">
                <thead>
                    <tr>
                        ...
                        <i class=\"far fa-plus-square\" style=\"font-size: 25px;\" ></i></button></th>
                        <th>Filial</th>
                        <th>Patrimônio</th>
                        <th>Jira</th>
                        <th>Defeito</th>
