...
<?php inicio_nav(); ?>
  <ul class="nav navbar-nav">
    ...
    <li class="nav-item"><a href="create.php" class="nav-link disabled">Adicionar</a></li>
    <li class="nav-item"><a href="update.php" class="nav-link disabled">Inserir Laudo</a></li>
    <li class="nav-item"><a href="tag.php?pagina=1" class="nav-link disabled">Gerar Etiqueta</a></li>
...
<?php
    ...
    <div class=\"row\">
        <div class=\"col-lg-12\">
            ...
            if (isset($_SESSION['aaa'])) { echo $_SESSION['aaa']; unset($_SESSION['aaa']);}
    ...
    <div class=\"d-flex justify-content-center\">
        <div class=\"col-lg-6 col-lg-offset-3\">
            <input type=\"search\" id=\"searcher\" onkeyup=\"searchBar()\" class=\"form-control\" placeholder=\"Busca rápida\"><br>

        </div>
    </div>
    <div class=\"row\">
        <div class=\"col-lg-12\">
            <table class=\"table table-hover\" id=\"manut_maquinas\">
                <thead>
                    <tr>
                    	<th> </th>
	...
	while ($row_manut = mysqli_fetch_assoc($resultado_usuario)) {
		...
		echo "<td>" . ucwords(utf8_encode(strtolower($row_manut['defeito']))) . "</td>";
		echo "<td>" . ucwords(utf8_encode(strtolower($row_manut['laudo_tec']))) . "</td>";
		$dt_exibida =  $row_manut['dt_manu'];
		echo "<td>" . inverteData($dt_exibida) . "</td>";
		echo "<td>" . ucwords(utf8_encode(strtolower($row_manut['OBS']))) . "</td>";
		echo "<td>" . ucwords(utf8_encode(strtolower($row_manut['tec_responsavel']))) . "</td>";
